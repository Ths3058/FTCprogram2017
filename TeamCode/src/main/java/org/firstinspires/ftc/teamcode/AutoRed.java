...
public class AutoRed extends OpMode {
    ...
    private final static double FWD2count = distToEnc(56);
    private final static double TURNL2count = degreesToEnc(108);
    ...
    private final static double TURNRcount = degreesToEnc(100);
    private final static double FWD4count = distToEnc(60);
    private final static double TURNL3count = degreesToEnc(137);
