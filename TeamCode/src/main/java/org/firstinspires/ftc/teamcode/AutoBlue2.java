...
public class AutoBlue2 extends OpMode {
    ...
    private final static double FWD2count = distToEnc(68);
    private final static double TURNR2count = degreesToEnc(80);
    ...
    private final static double TURNL1count = degreesToEnc(80);
    private final static double FWD4count = distToEnc(64);
    private final static double TURNR3count = degreesToEnc(143);
